...
// -----------------------------
// 1. BASE DE DATOS UNIFICADA (CORREGIDA)
// -----------------------------
const ALL_PRODUCTS = [
  // SERIE 100
  {
    ...
    precio: 280000,
    precio_ant: 350000,
    descripcion: "Diseñada para el entorno urbano hostil.",
  ...
  },
  {
    ...
    precio: 190000,
    precio_ant: 240000,
    descripcion: "Suela de fibra de carbono.",
  ...
  },
  {
    ...
    precio: 120000,
    precio_ant: 180000,
    descripcion: "Hoodie de algodón pesado.",
  ...
  },
  {
    ...
    precio: 350000,
    precio_ant: 450000,
    descripcion: "Gafas inteligentes con filtro UV.",
  ...
  // --- ID 105 CORREGIDO (IMAGEN CHICA GORRO) ---
  {
    id: 105,
  ...
  // SERIE 200
  {
    ...
    precio: 350000,
    precio_ant: 420000,
    img: "https://images.unsplash.com/photo-1602525582399-7ef5f604ff7e?w=500&auto=format&fit=crop&q=60",
    oferta: true,
    rating: 4.9,
    reviews: 32,
    tag: "Trending"
  ...
  },
  {
    ...
    precio: 420000,
    precio_ant: null,
    img: "https://images.unsplash.com/photo-1621315271772-28b1f3a5df87?auto=format&fit=crop&q=80&w=387",
    oferta: false,
    rating: 5.0,
    reviews: 89,
    tag: "Best Seller"
...
const ProductTargetModal = ({ product, onClose, onAddToCart }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/60 backdrop-blur-md animate-in fade-in" onClick={onClose}>
      <div
        // CORRECCIÓN 1: max-h-[90vh] y overflow-y-auto para que scrollee en móvil si es muy alto
        // CORRECCIÓN 2: md:overflow-hidden para que en PC no tenga scroll la tarjeta completa
        className="bg-white dark:bg-[#1a1a1a] w-full max-w-4xl max-h-[90vh] md:max-h-none rounded-[2.5rem] shadow-2xl flex flex-col md:flex-row relative animate-slide-up overflow-y-auto md:overflow-hidden"
        onClick={e => e.stopPropagation()}
      >
        {/* Botón cerrar asegurado arriba */}
        ...
        {/* CORRECCIÓN 3: Altura de imagen controlada en móvil (h-64) para dejar espacio al texto */}
        <div className="w-full md:w-1/2 h-64 md:h-auto bg-gray-50 dark:bg-gray-900 shrink-0 relative">
          <img src={product.img} className="w-full h-full object-cover" alt={product.nombre} />
        </div>

        {/* Contenido con scroll interno en Desktop si es necesario */}
        <div className="w-full md:w-1/2 p-6 md:p-10 flex flex-col dark:text-white md:overflow-y-auto">
          <span className="text-[10px] font-black uppercase tracking-[0.3em] text-red-600 mb-2">{product.categoria}</span>
          {/* Título un poco más pequeño en móvil (text-2xl) */}
          ...
          {/* CORRECCIÓN 4: Aquí agregamos la descripción que faltaba */}
...
function ProductosContent() {
  ...
  // SOLUCIÓN: Usamos ALL_PRODUCTS que es la variable definida arriba
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-12">
          {filteredProducts.map((product) => (
            <div key={product.id} className="group relative">
              ...
              {/* TARJETA DE IMAGEN */}
              {/* Cambio importante: product.img en vez de product.imagen */}
              <Link
